...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('E:\B.Tech\PROJECTS\Face recognition with python\data\haarcascade_frontalcatface_extended.xml')#Load haar classifier
